...
/// @nodoc
@JsonSerializable()
class _$_Picture extends _Picture with DiagnosticableTreeMixin {
  const _$_Picture(
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Picture(width: $width, height: $height, url: $url)';
  }
...
abstract class _Picture extends Picture {
  const factory _Picture(
      ...
      required final String url}) = _$_Picture;
  const _Picture._() : super._();
