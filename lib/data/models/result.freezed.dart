...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorType errorType) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(ApiErrorType errorType)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Failure<T> implements Failure<T> {
  const _$Failure(this.errorType);
  ...
  @override
  String toString() {
    return 'Result<$T>.failure(errorType: $errorType)';
  }
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(final ApiErrorType errorType) = _$Failure<T>;
